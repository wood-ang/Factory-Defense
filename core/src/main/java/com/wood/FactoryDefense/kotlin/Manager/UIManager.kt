...
import com.wood.FactoryDefense.kotlin.UI.Shape
...
class UIManager (
    ...
    val roots: BasicUIBlock = object : BasicUIBlock(Shape(displayWidth, displayHeight), UILayout(Arrangement.Vertical, 1, 0f, 0f)) {
